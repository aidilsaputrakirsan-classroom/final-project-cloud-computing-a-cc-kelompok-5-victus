    ...
    $date = $post->published_at ?? $post->created_at;
                                                    ...
                                                    <div class="post-content">
                                                        <ul class="post-list d-flex align-items-center">
                                                            ...
                                                            <li><i class="fa-regular fa-comment"></i> {{ $post->comments->count() }} Comments</li>
                                                            <li>
    ...
    $plainContent = trim(strip_tags($post->content ?? ''));
                                                ...
                                                <div class="comments-area">
                                                    ...
                                                    @foreach($post->comments as $comment)
                                                        <div class="blog-single-comment d-flex gap-4 pt-4 pb-4" id="comment-{{ $comment->id }}">
                                                            @php
            ...
            if (count($parts) > 1) {
                $initials .= strtoupper(mb_substr($parts[1], 0, 1));
                                                ...
                                                <div class="comment-form-wrap pt-5">
                                                    ...
                                                    <form action="{{ route('comments.store', $post) }}" id="comment-post-form" method="POST">
                                                        @csrf
                                                        <div class="row g-4">
                                                            <div class="col-lg-6">
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="form-clt"><span>Message*</span>
                                                                    <textarea name="content" placeholder="Write Message" class="form-control"
